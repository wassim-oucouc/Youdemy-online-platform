                        ...
                        <form action="" method="POST">
                            <div class="grid grid-cols-6 gap-6">
                                <div class="col-span-6 sm:col-span-3">
                                    ...
                                    <input type="text" name="name" id="product-name" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Entrer Nom Categorie" required="">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="brand" class="text-sm font-medium text-gray-900 block mb-2">Description</label>
                                    <input type="text" name="Description" id="brand" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Entrer Description Categorie" required="">
                                </div>
                                <div class="col-span-6 sm:col-span-3">
                                    <label for="price" class="text-sm font-medium text-gray-900 block mb-2">Specialite</label>
                                    <input type="text" name="Specialite" id="price" class="shadow-sm bg-gray-50 border border-gray-300 text-gray-900 sm:text-sm rounded-lg focus:ring-cyan-600 focus:border-cyan-600 block w-full p-2.5" placeholder="Entrer Specialite Categorie" required="">
                                </div>
                            </div>
                            ...
                            <tr>
                                ...
                                <td>
                                 <form action="/edit-categorie" method="POST">
                                        ...
                                        <button name = "editcategorie" class="fas fa-edit" type="submit"></button>
                                    </form>
                                    <form action="/delete-categorie" method="POST">
                                        <input type="hidden" name="id" value="'.$value['ID'].'">
                                        <button name = "deletecategorie"class="fas fa-trash" type="submit"></button>
                                    </form>
                                </td>
                            </tr>';
                        }
